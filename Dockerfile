...
ENTRYPOINT [ "/deployments/run-java.sh", "configuration/dev.properties", "schema.registry.ssl.truststore.location=/mnt/sslcerts/truststore.p12", "schema.registry.ssl.truststore.password=mystorepassword"]